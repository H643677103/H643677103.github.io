...
hexo.extend.filter.register("before_generate", () => {
  ...
  const internalSrc = {
    ...
    random_friends_post_js: {
      name: "hexo-theme-chyt",
      file: "js/chyt/random_friends_post.js",
      version,
    },
    right_click_menu_js: {
      name: "hexo-theme-chyt",
      file: "js/chyt/right_click_menu.js",
      version,
    },
    comment_barrage_js: {
      name: "hexo-theme-chyt",
      file: "js/chyt/comment_barrage.js",
      version,
    },
    ai_abstract_js: {
      name: "hexo-theme-chyt",
      file: "js/chyt/ai_abstract.js",
      version,
    },
    people_js: {
      name: "hexo-theme-chyt",
      file: "js/chyt/people.js",
      version,
    },
  };
  ...
  const createCDNLink = (data, type, cond = "") => {
    Object.keys(data).map(key => {
      ...
      const cdnSource = {
        ...
        chyt: `https://cdn.chyt.top/npm/${name}${verType}/${min_file}`,

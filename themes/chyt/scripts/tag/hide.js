...
function hideBlock (args, content) {
  ...
  return `<div class="hide-block"><button type="button" class="hide-button" ${group}>${display}</button><div class="hide-content">${hexo.render.renderSync({ text: content, engine: 'markdown' })}</div></div>`
}

window.addEventListener("load", () => {
  ...
  const openSearch = () => {
    ...
    chyt.animateIn(document.querySelector("#local-search .search-dialog"), "titleScale 0.5s");
    setTimeout(() => {
  ...
  const closeSearch = () => {
    ...
    bodyStyle.width = "";
    bodyStyle.overflow = "";
    chyt.animateOut(document.querySelector("#local-search .search-dialog"), "search_close .5s");
  ...
  const search = () => {
    ...
    $input.addEventListener("input", function () {
      ...
      if (keywords[0] !== "")
        $loadingStatus.innerHTML = '<i class="chytfont chyt-icon-spinner chyt-pulse-icon"></i>';
